...
<Callout type="info" title="The Zenix Philosophy">
  We believe that speed and beautiful design are not mutually exclusive. A theme
  should provide a rock-solid foundation, but get out of your way when you want
  to customize it.
</Callout>
...
<Callout type="success" title="Zero Configuration">
  View transitions are enabled by default in Zenix. You don't need to write a
  single line of JavaScript to get SPA-like routing.
</Callout>
...
<Callout type="warning" title="Content Tip">
  Keep reusable components simple and focused. They should make content easier
  to read, not harder to maintain.
</Callout>
...
<Callout type="danger" title="Customization Note">
  Replace the sample content, links, and metadata before publishing your own
  site.
</Callout>
